...
dir_np_chargrid_1h_test='/disk/lindong/graduate_task/chargrid-pytorch-master/chargrid-pytorch-master/data/np_chargrids_1h'+'/test'
train_index_filenames = [f for f in os.listdir(dir_np_chargrid_1h_test) if os.path.isfile(os.path.join(dir_np_chargrid_1h_test, f))]
